...
[("3D View",
  ...
  {"items":
   [("wm.call_menu_pie",
    ...
    ("wm.call_menu_pie",
     {"type": 'RIGHTMOUSE', "value": 'ANY', "shift": True},
     {"properties":
      [("name", 'SNA_MT_BA1C6'),
       ],
      },
    ...
    ("sna.my_generic_operator_896aa", {"type": 'V', "value": 'PRESS'}, None),
    ("sna.my_generic_operator_3936e", {"type": 'D', "value": 'PRESS', "ctrl": True}, None),
    ("sna.my_generic_operator_95174", {"type": 'D', "value": 'PRESS'}, None),
    ("wm.call_menu_pie",
     {"type": 'RIGHTMOUSE', "value": 'ANY', "shift": True},
     {"properties":
      [("name", 'SNA_MT_BA1C6'),
 ...
 ("Frames",
  ...
  {"items":
   [("screen.frame_offset",
    ...
    ("screen.animation_play", {"type": 'EQUAL', "value": 'PRESS'}, None),
 ...
 ("Mesh",
  ...
  {"items":
   [("mesh.loopcut_slide",
    ...
    ("mesh.faces_select_linked_flat", {"type": 'EQUAL', "value": 'PRESS', "repeat": True}, None),
    ],
   },
  ),
 ("Node Editor",
 ...
 ("Object Mode",
  ...
  {"items":
   [("object.booltool_auto_slice", {"type": 'NUMPAD_SLASH', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ...
    ("object.convert",
     {"type": 'H', "value": 'PRESS', "ctrl": True, "alt": True, "repeat": True},
     {"properties":
      [("target", 'MESH'),
       ],
      },
     ),
    ("object.add_fracture_cell_objects", {"type": 'NUMPAD_ASTERIX', "value": 'PRESS', "repeat": True}, None),
    ],
   },
  ),
 ("Outliner",
  ...
  {"items":
   [("outliner.highlight_update", {"type": 'MOUSEMOVE', "value": 'ANY', "any": True}, None),
    ...
    ("outliner.show_active", {"type": 'NUMPAD_PLUS', "value": 'PRESS'}, None),
  ...
  {"items":
   [("wm.call_panel",
    ...
    ("wm.context_toggle",
     ...
     {"properties":
      [("data_path", 'space_data.overlay.show_edge_sharp'),
       ],
      },
     ),
    ("wm.context_toggle",
     ...
     {"properties":
      [("data_path", 'scene.sna_xiankunagxianshi'),
       ],
      },
     ),
    ],
