...
import os
# 导入人物
Fbx_Path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "调用","资源","地面.fbx")
...
bpy.context.object.active_material.node_tree.nodes['Principled BSDF'].inputs['Base Color'].default_value = Color
