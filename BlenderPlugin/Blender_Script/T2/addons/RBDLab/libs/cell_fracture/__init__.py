...
class RBDLAB_FractureCell(Operator):
    bl_idname = "rbdlab.add_fracture_cell_objects"
...
def menu_func(self, context):
    layout = self.layout
    layout.separator()
    layout.operator("rbdlab.add_fracture_cell_objects", text="Cell Fracture")


def register():
    bpy.utils.register_class(RBDLAB_FractureCell)
    bpy.types.VIEW3D_MT_object_quick_effects.append(menu_func)


def unregister():
    bpy.utils.unregister_class(RBDLAB_FractureCell)
