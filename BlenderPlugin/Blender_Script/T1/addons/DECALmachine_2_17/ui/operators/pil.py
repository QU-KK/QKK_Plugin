...
class InstallPIL(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        print(f"\nDECALmachine: Installing PIL {DM.pil_version}\n")
        print("Platform:", platform.system())

        log.append(f"\nDECALmachine: Installing PIL {DM.pil_version}\n")
        log.append(f"Platform: {platform.system()}")
        ...
        if installed:
            ...
            installed = install_PIL(pythonbinpath, log, version=DM.pil_version, mode='USER', debug=self.debug)
...
class InstallPILAdmin(bpy.types.Operator):
    ...
    def invoke(self, context, event):
        ...
        print(f"\nDECALmachine: Installing PIL {DM.pil_version} (Admin)\n")
        print("Platform:", platform.system())
        ...
        if installed:
            ...
            installed = install_PIL(pythonbinpath, log, version=DM.pil_version, mode='ADMIN', debug=debug)
...
class EasyInstallPILAdmin(bpy.types.Operator):
    ...
    def invoke(self, context, event):
        ...
        print(f"\nDECALmachine: Easy Installing PIL {DM.pil_version} (Admin)\n")
        print("Platform:", platform.system())
        ...
        if installed:
            ...
            installed = easy_install_PIL(pythonbinpath, easyinstallpath, easyinstalluserpath, log, version=DM.pil_version, mode='ADMIN', debug=debug)
