...
from .. utils.registration import get_prefs, get_templates_path, register_atlases, update_instantatlascount, get_version_as_tuple
...
class Export(bpy.types.Operator):
    ...
    def export_models(self, context, dm, format, path, folder):
        ...
        if format == 'OBJ':
            bpy.ops.wm.obj_export('INVOKE_DEFAULT', filepath=filepath, export_selected_objects=True if context.selected_objects else False)
            ...
            bpy.ops.export_scene.gltf('INVOKE_DEFAULT', filepath=filepath, use_selection=True if context.selected_objects else False)
