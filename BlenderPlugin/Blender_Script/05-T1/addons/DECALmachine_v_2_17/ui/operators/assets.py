...
from ... utils.assets import declutter_assetspath, get_indexed_suffix_name, reload_all_assets, get_invalid_libs, get_corrupt_libs
...
class QuarantineLibrary(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        assets_dict = DM.get_assets_dict(force=bool(decluttered))
